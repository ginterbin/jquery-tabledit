...
(function(a){a.fn.Tabledit=function(g){function f(b){var e="";a(d.find(".tabledit-input:not(.tabledit-identifier)")).each(function(){a(this).prop("disabled")||(e="id="+d.find(a(this)).parents("tr").attr(c.rowIdentifier))});if("delete"==b){var k=a(".tabledit-confirm-button.active"),e="id="+k.parents("tr").attr(c.rowIdentifier);k.removeClass("active")}else"delete"!=b&&(e+="&");k=e+d.find(".tabledit-input:not(.tabledit-identifier)").serialize()+"&action="+b+"&table="+d.attr("data-info-table");if(!1===
